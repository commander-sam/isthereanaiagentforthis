        ...
        <table className="min-w-full divide-y divide-gray-800">
          <thead className="bg-gray-800/50">
            <tr>
              ...
              <th className="px-4 py-2 text-left text-xs font-medium text-gray-400">Website</th>
            </tr>
          </thead>
          <tbody className="bg-gray-900/50 divide-y divide-gray-800">
            {agents.map((agent, index) => (
              <tr key={index}>
                ...
                <td className="px-4 py-2 text-sm text-gray-300 max-w-xs truncate">{agent.shortDescription}</td>
                ...
                <td className="px-4 py-2 text-sm text-gray-300 max-w-xs truncate">{agent.websiteUrl}</td>
              </tr>
            ))}
          </tbody>
        </table>
